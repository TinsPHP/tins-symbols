...
public class AErroneousSymbolWithAccessModifier_ASymbol_LSPTest extends ASymbolTest
{
    ...
    protected ASymbol createSymbol(ITSPHPAst definitionAst, String name) {
        return new DummyErroneousSymbolWithAccessModifier(definitionAst, name, new TSPHPException());
    }
}
