...
public class ConstantFunctionTypeSymbol_ASymbolWithModifier_LSPTest extends ASymbolWithModifierTest
{

    @Override
    protected ASymbolWithModifier createSymbolWithModifier(
            ITSPHPAst definitionAst, IModifierSet modifiers, String name) {
        ConstantFunctionTypeSymbol function = new ConstantFunctionTypeSymbol(name, null, null, null);
