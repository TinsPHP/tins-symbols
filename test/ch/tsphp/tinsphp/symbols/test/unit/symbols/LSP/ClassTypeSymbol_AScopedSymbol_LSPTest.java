...
public class ClassTypeSymbol_AScopedSymbol_LSPTest extends AScopedSymbolTest
{
...
//        assertThat(result, hasEntry("dummy", true));
    ...
    protected AScopedSymbol createScopedSymbol(IScopeHelper scopeHelper, ITSPHPAst definitionAst,
        ...
        return new ClassTypeSymbol(scopeHelper, definitionAst, modifiers, name, enclosingScope, typeSymbol);
    }
}
