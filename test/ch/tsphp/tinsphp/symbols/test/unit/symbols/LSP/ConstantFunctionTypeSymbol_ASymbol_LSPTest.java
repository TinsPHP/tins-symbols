...
public class ConstantFunctionTypeSymbol_ASymbol_LSPTest extends ASymbolTest
{
    @Override
    public void getDefinitionAst_Standard_ReturnsOnePassedToConstructor() {
        // different behaviour - constant function types are pre-defined types which do not have a definition Ast
    ...
    protected ASymbol createSymbol(ITSPHPAst definitionAst, String name) {
        return new ConstantFunctionTypeSymbol(name, null, null, null);
    }
}
